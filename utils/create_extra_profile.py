...
-----------------------------------------------------------------------------------------------
 ...
 DESCRIPTION
   ...
   Eta, created at the same point and with the same resolution. To compute the bulk sound speed
...
if __name__ == '__main__':
  ...
  if prm == 'iso' or prm == 'cb' or prm == 'vpvs' or prm == 'diso' or prm == 'dcb':
    ...
    mm1 = meanModel ('vsv.dat')
    mm2 = meanModel ('vsh.dat')
    ...
    file = '{}_PF.dat'.format (prm[1:])

    depth, ndep, point, M = readGridFile (file)
